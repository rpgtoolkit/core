...
public class TileSetCache {
    ...
    /**
     * Allows the calling object to check if the tile set has already been
     * loaded, this should be checked before calling loadTileSet
     *
    ...
    /**
     * Adds the specified tile set into the cache, it will only load the file
     * if it is not already present in the cache, it is important to call
    ...
    /**
     * Removes the specified TileSet from the cache, it will only remove the 
     * TileSet if the number of board references have reached 0.
     *
    ...
    /**
     * Removes the specified TileSets from the cache, it will only remove the 
     * TileSet if the number of board references have reached 0.
     *

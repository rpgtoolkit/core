...
/**
 * A repository that stores, serializes, and caches game assets.
 *
...
public interface AssetRepository {
    ...
    /**
     * Registers an asset handle resolver. Asset handle resolvers are used to
     * resolve asset descriptors (URIs) into handles that pair descriptors with
     * assets and expose I/O.
     *
    ...
    /**
     * Registers an asset serializer. Asset serializers are used to read
     * (deserialize) or write (serialize) assets.
     *
    ...
    /**
     * Returns an asset handle for the asset if the asset was previously loaded
     * by the repository.
     *
    ...
    /**
     * Loads a game asset with the specified descriptor. The descriptor will be
     * parsed for validity.
     *
    ...
    /**
     * Loads a game asset with the specified descriptor. The repository will
     * search for an asset handle resolver that is capable of resolving the
     * descriptor into a handle.
     *
     * If the handle is valid and resolvable the repository searches for an
     * asset serializer that is capable of deserializing the handle.
     *
     * If the handle is still valid and deserializable then the repository uses
     * the serializer to deserialize the asset and attach it to the handle.
     *
    ...
    /**
     * Removes the asset identified by the descriptor from repository
     * management.
     *
     * @param descriptor asset descriptor (non null)
     */
